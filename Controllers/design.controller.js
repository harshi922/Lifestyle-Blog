...
app
    .controller("designController", ["$scope", "d", "categories", "$anchorScroll", "$location", function ($scope, d, categories, $anchorScroll, $location) {
        $scope.blogs = [
        ...
        $scope.desBlogsFind = function () {
            ...
            for (var i = 0; i < $scope.blogs.length; i++) {
                if ($scope.blogs[i].category == "design") {
